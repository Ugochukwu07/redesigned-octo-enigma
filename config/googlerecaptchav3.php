...
return [
    ...
    */
    ...
    |
    */
    'host_name' => 'https://www.google.com/recaptcha/admin',
    /*
    |--------------------------------------------------------------------------
    | Secret Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'secret_key' => env('RECAPTCHA_V3_SECRET_KEY', '6LcP1MwfAAAAAGqfmvZJWfflya5X43BrPbrmb01m'),
    /*
    |--------------------------------------------------------------------------
    | Site Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'site_key' => env('RECAPTCHA_V3_SITE_KEY', '6LcP1MwfAAAAAGd8658bWSuWlLAchN7RWsiIkQCe'),
